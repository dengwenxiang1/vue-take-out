        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <!-- 赞或踩 -->
                <span class="iconfont" :class="rating.rateType===0 ? 'icon-thumb_up' :'inco-thumb_down'"></span>
...
import Star from '../../compoments/Star/Star.vue'
export default({
    data() {
        return {
        ...
        return ratings.filter(rating => {
            ...
            /*
              条件1：
                selectType:0/1/2
                rateType:0/1
                selectType===2 || selectype===rateType
                条件2：
