...
export const RECEIVE_INFO = 'receive_info'// 接收商家评价数组
export const RECEIVE_RATINGS = 'receive_ratings'// 接收商家信息
...
export const RECEIVE_SEARCH_SHOPS = 'receive-search-shops'// 接收搜索商家数组
